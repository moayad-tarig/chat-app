        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    @forelse ($messages as $message)
                        ...
                        @else
                            <div class="flex gap-2.5 justify-end pb-3">
                                ...
                                <img src="https://pagedone.io/asset/uploads/1704091591.png" alt="User image"
                                    class="w-10 h-11">
                            </div>
                        @endif
                    @empty
            ...
            <form wire:submit.prevent="sendMessage"
                ...
                <div
                    ...
                    <input autocomplete="off" type="text" wire:model="message" wire:keydown="userTyping"
                        id="message-input"
...
@script
    <script>
        ...
        let typingTimeout;
        window.Echo.private('typing-channel.{{ auth()->user()->id }}').listen('ChatTypingEvent', function(event) {
